...
if __name__ == "__main__":
    ...
    for degree in degrees:
        ...
        print(f"Degree: {degree}, Explicit: {total_time_explicit:.2f}s, Implicit: {total_time_implicit:.2f}s")
    ...
    plt.plot(degrees, errors_explicit, label="Explicit")
    plt.plot(degrees, errors_implicit, label="Implicit")
    plt.xlabel("Degree")
    plt.ylabel("Error")
    plt.title("Error comparison between explicit and implicit schemes for different degrees")
    plt.legend()
    plt.savefig("degree_error_comparison.png")
    plt.show()
