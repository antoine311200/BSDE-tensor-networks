...
if __name__ == "__main__":
    ...
    for assets in n_assets:
        ...
        print(f"Assets: {assets}, Explicit: {total_time_explicit:.2f}s, Implicit: {total_time_implicit:.2f}s")
    ...
    plt.plot(n_assets, errors_explicit, label="Explicit")
    plt.plot(n_assets, errors_implicit, label="Implicit")
    plt.xlabel("Number of assets")
    plt.ylabel("Error")
    plt.title("Error comparison between explicit and implicit schemes for different number of assets")
    plt.legend()
    plt.savefig("assets_error_comparison.png")
    plt.show()
