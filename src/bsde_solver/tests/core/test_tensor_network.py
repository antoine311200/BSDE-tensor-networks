...
if __name__ == "__main__":
    ...
    tensor = TensorCore(xp.random.rand(2, 3, 4), indices=('axis_0', 'axis_1', 'axis_2'))
    ...
    tc = TensorCore(xp.random.rand(2, 3, 4, 5, 6), indices=('axis_a', 'axis_b', 'axis_c', 'axis_d', 'axis_e'))
    print(tc)
    ...
    tn = TensorNetwork([
        TensorCore(xp.random.rand(2, 3, 4), indices=('axis_0', 'axis_1', 'axis_2')),
        TensorCore(xp.random.rand(4, 5, 6), indices=('axis_2', 'axis_3', 'axis_4'))
    ])
    print(tn)

    tn.add_core(TensorCore(xp.random.rand(2, 3, 4), indices=('axis_4', 'axis_5', 'axis_6')))
    tn.add_core(TensorCore(xp.random.rand(2, 3, 4), indices=('axis_6', 'axis_7', 'axis_8')))
    tn.add_core(TensorCore(xp.random.rand(2, 3, 4), indices=('axis_8', 'axis_9', 'axis_10')))
    print(tn)
    ...
    xp.set_printoptions(precision=10)
    ...
    left_unfolding = left_unfold(core).view(xp.ndarray)
    print(f"\nLeft unfolding ({core}):")
    print(left_unfold(core))
    ...
    core = mps.cores[f'core_{1}']
    right_unfolding = right_unfold(core).view(xp.ndarray)
    print(f"\nLeft unfolding ({core}):")
    print(right_unfold(core))
